...
str_formatter = SRTFormatter()
str_formatterted = str_formatter.format_transcript(transcript)
print(str_formatterted[:150])
print('-' * 50)
...
with open(srt_file, 'w', encoding='utf-8') as f:
    f.write(str_formatterted)

text_file = f'{download_folder}/{video_id}.txt'
print('- 텍스트 파일 저장 : ', text_file)
