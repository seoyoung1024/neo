...
print('\n1 row data read of serice')
result = myframe.iloc[1]
print(type(result))
print(result)
print('-' * 50)

print('\nmulti row data read of serice')
result = myframe.iloc[[1, 3]]
print(type(result))
print(result)
print('-' * 50)

print('\even row data read of serice')
result = myframe.iloc[0::2]
print(type(result))
print(result)
print('-' * 50)

print('\김유신 include row data read of serice')
...
print('\김유신 이순신 include row data read of serice')
...
print('\ 이순신 광주 실적 include row data read of serice')
...
print('\ 이순신, 강감찬 / 광주, 목포 실적 include row data read of serice')
...
print('\ 이순신 ~ 강감찬 / 서울~ 목포 실적 include row data read of DataFrame')
result = myframe.loc['이순신':'강감찬','서울':'목포']
print(type(result))
print(result)
print('-' * 50)

print('\n 김유신~ 광해군 / 부산 실적 include row data read of serice')
...
print('\n서울 실적 >= 100')
result = myframe.loc[myframe['서울'] >= 100]
print(result)
print('-' * 50)

print('\n서울 실적 >= 100 and 광주 실적 >= 100')
result = myframe.loc[(myframe['서울'] >= 100) & (myframe['광주'] >= 100)]
print(result)
print('-' * 50)
